...
export const getMenstruationPredictions = (events: Event[], predictionPeriod: number) => {
    ...
    if (menstruationPeriods.length == 0) return []
    ...
    if (timesBetweenMenstruationPeriods.length == 0) return []
...
export const getOvulationPredictions = (events: Event[], predictionPeriod: number) => {
    ...
    if (ovulationPeriods.length == 0) return []
    ...
    if (timesBetweenOvulationPeriods.length == 0) return []
